...
export default function TopNav({ page, setPage, user, profile, inventoryAlerts, onLogout, onSettings }) {
    ...
    <div style={{ height:56, background:'linear-gradient(135deg,#0891b2 0%,#0e7490 100%)', display:'flex', alignItems:'center', padding:'0 20px', flexShrink:0, position:'relative', borderBottom:'1px solid rgba(255,255,255,.15)' }}>
      ...
      <div style={{ display:'flex', alignItems:'center', gap:10, marginRight:36, flexShrink:0 }}>
        ...
        <div style={{ display:'flex', alignItems:'center' }}>
          <span style={{ fontSize:16, fontWeight:800, color:'#fff', letterSpacing:'-0.04em' }}>EasySecurity</span>
      ...
      <div style={{ display:'flex', alignItems:'center', gap:10, flexShrink:0, marginLeft:'auto' }}>
        ...
        <div onClick={onSettings} title="Settings"
          style={{ width:32, height:32, borderRadius:'50%', background:'rgba(255,255,255,.15)', border:'1px solid rgba(255,255,255,.2)', display:'flex', alignItems:'center', justifyContent:'center', cursor:'pointer' }}>
          <svg width="15" height="15" viewBox="0 0 20 20" fill="none"><path d="M10 13a3 3 0 100-6 3 3 0 000 6z" stroke="rgba(255,255,255,.8)" strokeWidth="1.5"/><path d="M10 2v1.5M10 16.5V18M2 10h1.5M16.5 10H18M4.1 4.1l1.05 1.05M14.85 14.85l1.05 1.05M4.1 15.9l1.05-1.05M14.85 5.15l1.05-1.05" stroke="rgba(255,255,255,.8)" strokeWidth="1.5" strokeLinecap="round"/></svg>
        </div>
