        ...
        {!loading && display.length>0 && (
          <>
            ...
            <div style={{ background:'#fff', border:'1px solid #e5e7eb', borderRadius:12, overflow:'hidden' }}>
              ...
              {/* Column header */}
              <div style={{ display:'grid', gridTemplateColumns:'110px minmax(0,1.8fr) minmax(0,0.8fr) 100px 130px 90px', padding:'8px 14px', background:'#f9fafb', borderBottom:'1px solid #f0f0f0' }}>
...
function CertRow({ row, idx, total, onSelect }) {
  ...
  return (
    <div onMouseEnter={()=>setHov(true)} onMouseLeave={()=>setHov(false)} onClick={()=>onSelect(row)}
      style={{ display:'grid', gridTemplateColumns:'110px minmax(0,1.8fr) minmax(0,0.8fr) 100px 130px 90px', padding:'10px 14px', borderBottom:idx<total-1?'1px solid #f5f5f5':'none', alignItems:'center', background:hov?'#f8f9ff':idx%2===0?'#fff':'#fdfdfd', transition:'background 0.1s', cursor:'pointer' }}>
