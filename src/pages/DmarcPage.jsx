...
export default function DmarcPage({ user, initialTab }) {
  ...
  async function handleSingleCheck(e) {
    ...
    try {
      ...
      setResult(r)
      setHistory(prev => [{ id:Date.now(), domain:d, score:r.score, dmarc_status:r.dmarc.status, spf_status:r.spf.status, dkim_status:r.dkim.status, checked_at:r.checkedAt, raw_json:{dmarc:r.dmarc,spf:r.spf,dkim:r.dkim} }, ...prev].slice(0,30))
